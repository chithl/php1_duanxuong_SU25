...
if (isset($_SESSION["messageLogin"])):
	...
	<div class="alert alert-warning alert-dismissible" role="alert">
		<strong><?= $_SESSION["messageLogin"] ?? "" ?></strong>
	</div>
<?php
endif;
?>
					...
					<div class="login-right">
						...
						<form id="loginForm" method="post" action="?page=login&action=handle">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="text" name="username" placeholder="Nhập tên người dùng của bạn" value="<?= $old_data["username"] ?? "" ?>">
							...
							<div class="mb-3">
								...
								<input type="password" class="form-control" id="password" name="password" placeholder="Nhập mật khẩu" value="<?= $old_data["password"] ?? "" ?>">
