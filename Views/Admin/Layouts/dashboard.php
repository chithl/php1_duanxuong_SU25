                      ...
                      <span class="todo-desc fw-normal">Lorem Ipsum is simply dummy text of the printing
                        and typesetting industry.</span>
                                        ...
                                        <ul class="list-style-none assignedto">
                                            <li class="assignee">
                                                <img class="rounded-circle" width="40" src="Assets/Admin/images/users/1.jpg" alt="user"
                                                     data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave" />
                                            </li>
                                            <li class="assignee">
                                                <img class="rounded-circle" width="40" src="Assets/Admin/images/users/2.jpg" alt="user"
                                                     data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica" />
                                            </li>
                                            <li class="assignee">
                                                <img class="rounded-circle" width="40" src="Assets/Admin/images/users/3.jpg" alt="user"
                                                     data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka" />
                                            </li>
                                            <li class="assignee">
                                                <img class="rounded-circle" width="40" src="Assets/Admin/images/users/4.jpg" alt="user"
                        ...
                        <div class="card-body">
                            ...
                            <div class="chat-box scrollable" style="height: 475px">
                                ...
                                <ul class="chat-list">
                                    ...
                                    <li class="chat-item">
                                        <div class="chat-img">
                                            <img src="Assets/Admin/images/users/1.jpg" alt="user" />
                                        </div>
                                    ...
                                    <li class="chat-item">
                                        <div class="chat-img">
                                            <img src="Assets/Admin/images/users/2.jpg" alt="user" />
                                        </div>
                                        <div class="chat-content">
                                    ...
                                    <li class="chat-item">
                                        <div class="chat-img">
                                            <img src="Assets/Admin/images/users/3.jpg" alt="user" />
                                        </div>
                                        <div class="chat-content">
                  ...
                  type setting industry.
                    ...
                    <div id="accordian-4">
                        <div class="card mt-4">
                            ...
                            <a class="card-header link border-top" data-toggle="collapse" data-parent="#accordian-4" href="#Toggle-2"
                               aria-expanded="false" aria-controls="Toggle-2">
