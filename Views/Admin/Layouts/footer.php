...
<!-- All Jquery -->
<!-- ============================================================== -->
<script src="Assets/Admin/libs/jquery/dist/jquery.min.js"></script><!-- Bootstrap tether Core JavaScript -->
<script src="Assets/Admin/libs/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<script src="Assets/Admin/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js"></script>
<script src="Assets/Admin/extra-libs/sparkline/sparkline.js"></script><!--Wave Effects -->
<script src="Assets/Admin/dist/js/waves.js"></script><!--Menu sidebar -->
<script src="Assets/Admin/dist/js/sidebarmenu.js"></script><!--Custom JavaScript -->
<script src="Assets/Admin/dist/js/custom.min.js"></script><!--This page JavaScript --><!-- <script src="Assets/dist/js/pages/dashboards/dashboard1.js"></script> --><!-- Charts js Files -->
