...
<div class="page-wrapper">
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<form class="form-horizontal" action="?page=blog&action=store" method="post" enctype="multipart/form-data">
						<div class="card-body">
							<h4 class="card-title">SỬA BÀI VIẾT</h4>

							<div class="form-group row">
								<label for="title" class="col-sm-3 text-end control-label col-form-label">Tiêu đề</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="title" name="title" placeholder="Nhập vào tiêu đề bài viết ..." value="<?= $old['title'] ?? '' ?>"/>
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									<textarea type="text" class="form-control" id="content" name="content" placeholder="Nhập nội dung bài viết ..."><?= $old['content'] ?? '' ?></textarea>
									<small id="helpId" class="text-danger"><?= $errors['content'] ?? "" ?></small>
								</div>
							</div>
							<div class="form-group row">
								<label for="blog_category_id" class="col-sm-3 text-end control-label col-form-label">Mã loại</label>
								<div class="col-sm-9">
							...
							<div class="form-group row">
								...
								<div class="col-sm-9">
									...
									<small id="helpId" class="text-danger"><?= $errors['image'] ?? "" ?></small>
								</div>
							</div>
